                        ...
                        <li>
                            ...
                            <ul class="menu">
                                <li><!-- start message -->
                                    <a href="#">
                                        <div class="pull-left">
                                            <img src="{{ URL::asset('assets/admin/user2-160x160.jpg') }}" class="img-circle" alt="User Image" width="160px" height="160px">
                                        </div>
                                        <h4>
                                            Support Team
                                ...
                                <li>
                                    <a href="#">
                                        <div class="pull-left">
                                            <img src="{{ URL::asset('assets/admin/user3-128x128.jpg') }}" class="img-circle" alt="User Image">
                                        </div>
                                        <h4>
                                ...
                                <li>
                                    <a href="#">
                                        <div class="pull-left">
                                            <img src="{{ URL::asset('assets/admin/user4-128x128.jpg') }}" class="img-circle" alt="User Image">
                                        </div>
                                        <h4>
                                            Developers
